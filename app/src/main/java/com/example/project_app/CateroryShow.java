...
public class CateroryShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CateroryShow.this, ShopActivity.class);
        ...
        homeIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CateroryShow.this, HomeActivity.class);
                startActivity(intent);
            }
        });
        ...
        profileIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CateroryShow.this, profil_docterpty.class);
                startActivity(intent);
            }
        });
